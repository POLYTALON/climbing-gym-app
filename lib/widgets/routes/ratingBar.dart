...
class PolyRatingBar extends StatefulWidget {
  final int starCount;
  double rating;
  ...
  @override
  _PolyRatingBarState createState() => _PolyRatingBarState();
}

class _PolyRatingBarState extends State<PolyRatingBar> {
  ...
  @override
  void didUpdateWidget(PolyRatingBar oldWidget) {
    if (currentRating != widget.rating) {
      setState(() {
        currentRating = widget.rating;
      });
    }
  ...
  Widget buildStar(BuildContext context, int index) {
    ...
    if (index >= currentRating) {
      icon = Icon(
        ...
        color: widget.inactiveColor ?? Theme.of(context).primaryColor,
        size: widget.size,
      );
    } else if (index >
            currentRating -
